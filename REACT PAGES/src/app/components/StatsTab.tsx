...
export function StatsTab({ movies }: Props) {
  ...
  movies.forEach((m) =>
    (m.services ?? []).forEach((s) => {
      if (s) platformCounts[s] = (platformCounts[s] || 0) + 1;
    })
  );
    ...
    <div className="space-y-6 pb-8">
        ...
        {[
          ...
          <div key={stat.label} className="rounded-xl p-4 border border-[#1f1f1f]" style={{ backgroundColor: '#111' }}>
            ...
            <p
              ...
              style={{ color: stat.accent ? ACCENT : 'white' }}
            >
              {stat.value}
            </p>
          </div>
      ...
      {tags.length > 0 && (
        <div className="rounded-xl p-5 border border-[#1f1f1f]" style={{ backgroundColor: '#111' }}>
          <p className="text-gray-400 text-xs font-medium uppercase tracking-wider mb-3">Taste Profile</p>
      ...
      {/* ── Top 10 highest rated ───────────────────────────────── */}
      <div className="rounded-xl p-5 border border-[#1f1f1f]" style={{ backgroundColor: '#111' }}>
        <p className="text-gray-400 text-xs font-medium uppercase tracking-wider mb-4">Top 10 Highest Rated</p>
          ...
          {top10.map((m, i) => (
            <div key={m.movie_id} className="flex items-center gap-3">
              ...
              {m.poster ? (
                ...
                <div className="w-8 h-12 rounded shrink-0 flex items-center justify-center" style={{ backgroundColor: '#1f1f1f' }}>
              ...
              <span
                className="text-xs font-bold rounded-full px-2 py-0.5 text-black shrink-0"
                style={{ backgroundColor: ACCENT }}
              >
                {m.user_rating}
              </span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {topActors.length > 0 && (
          <div className="rounded-xl p-5 border border-[#1f1f1f]" style={{ backgroundColor: '#111' }}>
            <p className="text-gray-400 text-xs font-medium uppercase tracking-wider mb-4">Most Watched Actor</p>
            <div className="space-y-3">
        ...
        {topDirectors.length > 0 && (
          <div className="rounded-xl p-5 border border-[#1f1f1f]" style={{ backgroundColor: '#111' }}>
            <p className="text-gray-400 text-xs font-medium uppercase tracking-wider mb-4">Most Watched Director</p>
            <div className="space-y-3">
      ...
      {topGenres.length > 0 && (
        <div className="rounded-xl p-5 border border-[#1f1f1f]" style={{ backgroundColor: '#111' }}>
          <p className="text-gray-400 text-xs font-medium uppercase tracking-wider mb-4">Genre Breakdown</p>
          <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {decades.length > 0 && (
          <div className="rounded-xl p-5 border border-[#1f1f1f]" style={{ backgroundColor: '#111' }}>
            <p className="text-gray-400 text-xs font-medium uppercase tracking-wider mb-4">By Decade</p>
            <div className="space-y-3">
        ...
        {topPlatforms.length > 0 && (
          <div className="rounded-xl p-5 border border-[#1f1f1f]" style={{ backgroundColor: '#111' }}>
            <p className="text-gray-400 text-xs font-medium uppercase tracking-wider mb-4">Most Watched On</p>
            <div className="space-y-3">
