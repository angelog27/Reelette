...
import {
  ...
  Tv, Wifi, WifiOff, Loader2, Sparkles, Clapperboard, Send, Bell,
} from 'lucide-react';
...
export function SocialTab() {
  ...
  useEffect(() => {
    ...
    const fetchNotifs = async () => {
      ...
      // Toast for genuinely new unread notifications since last poll
      if (prevNotifCountRef.current > 0 && newUnread > prevNotifCountRef.current) {
    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="relative" ref={notifPanelRef}>
          ...
          {notifOpen && (
            <div className="absolute right-0 top-12 w-80 max-h-[480px] flex flex-col bg-[#141414] border border-[#2A2A2A] rounded-2xl shadow-2xl z-50 overflow-hidden">
              {/* Panel header */}
