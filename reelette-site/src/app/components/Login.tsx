...
export function Login() {
  ...
  return (
    <div className="bg-white relative size-full">
      ...
      {/* Logo */}
      <div className="absolute h-[459px] left-[491px] top-[19px] w-[458px]">
        <img alt="Reelette Logo" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src="https://images.unsplash.com/photo-1563381013529-1c922c80ac8d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb3ZpZSUyMHRoZWF0ZXIlMjBsb2dvJTIwbmVvbnxlbnwxfHx8fDE3NzM5NDMyMDd8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral" />
      </div>
    </div>
  );
}