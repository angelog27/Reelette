import imgReeletteLogoModernStacked1 from "figma:asset/fc7879cebdfa7239873f1bc07ecd89f7de07ad1a.png";

export default function LoginDesktop() {
  return (
    <div className="bg-white relative size-full" data-name="Login-Desktop-1">
      ...
      <div className="absolute bg-[#8d0000] h-[77px] left-[131px] rounded-[13px] top-[911px] w-[322px]" />
      <p className="absolute font-['Prompt:Regular',sans-serif] h-[113px] leading-[normal] left-[220px] not-italic text-[48px] text-white top-[911px] w-[209px] whitespace-pre-wrap">Login</p>
      <p className="absolute font-['Prompt:Regular',sans-serif] h-[22px] leading-[normal] left-[29px] not-italic text-[#8d0000] text-[16px] top-[849px] w-[323px] whitespace-pre-wrap">Forgot Password?</p>
      <div className="absolute h-[459px] left-[491px] top-[19px] w-[458px]" data-name="reelette_logo_modern_stacked 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgReeletteLogoModernStacked1} />
      </div>
    </div>
  );
}